...
export default function AffordableProperties({ affordableProperties }: any) {
  const [properties, setProperties] = useState(affordableProperties);
  ...
  const handleLoadMore = () => {
    ...
    setTimeout(() => {
      setProperties([...properties, ...affordableProperties]);
      setLoading(false);
    }, 1000);
  };
