...
export default function PropertyTypeList({ data }:any) {
  ...
  const handleEdit = (id:string) => {
    router.push(`/admin/property-type/edit/${id}`);
  };
  ...
  return (
    ...
    /> 
    <div className="rounded-[10px] border border-stroke mt-10 bg-white p-4 shadow-sm dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
